...
class GameUI(tk.Frame):
    ...
    def draw_piece(self, index, first_player):
        ...
        y = int(index / 3) * 80 + 10
        if first_player:
            self.c.create_oval(x, y, x + 60, y + 60,
    ...
    def on_draw(self):
        ...
        self.c.create_line(80, 0, 80, 240, width=2.0, fill='#0077FF')
        self.c.create_line(160, 0, 160, 240, width=2.0, fill='#0077FF')
        self.c.create_line(0, 80, 240, 80, width=2.0, fill='#0077FF')
        self.c.create_line(0, 160, 240, 160, width=2.0, fill='#0077FF')
        for i in range(9):
